...
| Next step | **Live on Google Play since 2026-09-10** (version 1.0.0, code 4, approved after four days in review). Source published the same day; plainpdf.app/source links to it. Version code 6 approved and live. **Version code 7 is built and waiting for upload** (Production > Create new release): the startup baseline profile and the status bar spacing fix |
...
- 2026-09-10 Evening: startup baseline profile recorded and shipped, status bar spacing fix, version code 7 built.
