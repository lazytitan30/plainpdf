...
| Next step | **Live on Google Play since 2026-09-10** (version 1.0.0, code 4, approved after four days in review). Source published the same day; plainpdf.app/source links to it. **Version code 6 uploaded to Production on 2026-09-10, in review**: bottom sheets scroll (the Honor Magic 7 report), working-notification title, large-font and landscape fixes, notification permission request |
