...
| Next step | **Live on Google Play since 2026-09-10** (version 1.0.0, code 4, approved after four days in review). Source published the same day; plainpdf.app/source links to it. **Version code 6 uploaded to Production on 2026-09-10, in review**. Two more changes sit on `main` unreleased, for whenever version code 7 is cut: the baseline profile and the status bar spacing fix |
...
### Startup baseline profile (2026-09-10, on `main`, unreleased)
...
### Status bar spacing (2026-09-10, on `main`, unreleased)
